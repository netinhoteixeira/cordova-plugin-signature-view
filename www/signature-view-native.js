    ...
    getSignature: function (successCallback, errorCallback) {
        ...
        cordova.exec(function (data) {
            ...
            if (!data) {
                ...
                var width = trailerView.getUint32(data.byteLength - 8);
                var height = trailerView.getUint32(data.byteLength - 4);
                ...
                var pixelData = new Uint8Array(data, 0, data.byteLength - 8);
