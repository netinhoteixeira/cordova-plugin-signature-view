...
public class SignatureView extends View {
     ...
     */
    private final float STROKE_WIDTH = 2.5f;//1.5f; // TODO: Make this dependent on pressure
    private final float HALF_STROKE_WIDTH = .75f;
    ...
    /**
     * Extract the current bitmap state of the display. Returns an immutable
     * ARGB_8888 bitmap or null if nothing has been drawn.
     */
